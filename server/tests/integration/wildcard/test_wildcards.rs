mod tests {
    ...
    fn testing_subscribe_and_publish_with_wildcard_astherisc_after_the_bar() {
        ...
        let subscriber_partidos_connect_bytes = [
            ...
            0x00, // Flags
            0x00, 0x0B, // keep alive
            0x00, 0x02, 0x63, 0x62, // Client Identifier
        ];
        ...
        let subscriber_with_wildcard_connect_bytes = [
            ...
            0x00, // Flags
            0x00, 0x0B, // keep alive
            0x00, 0x02, 0x63, 0x72, // Client Identifier
        ];
    ...
    fn testing_subscribe_and_publish_with_wildcard_greater_than() {
        let server = ServerTest::start("0.0.0.0:1902".to_string());

        let mut stream_to_create_topic_goles =
            TcpStream::connect("0.0.0.0:1902".to_string()).unwrap();
        let mut stream_to_create_topic_partidos =
            TcpStream::connect("0.0.0.0:1902".to_string()).unwrap();
        let mut stream_to_subscribe_with_wildcard =
            TcpStream::connect("0.0.0.0:1902".to_string()).unwrap();
        let mut stream_to_publish_message = TcpStream::connect("0.0.0.0:1902".to_string()).unwrap();
    ...
    fn testing_subscribe_and_publish_with_wildcard_astherisc_and_greater_than() {
        ...
        let subscriber_partidos_connect_bytes = [
            ...
            0x00, // Flags
            0x00, 0x00, // keep alive
            0x00, 0x02, 0x67, 0x64, // Client Identifier
        ];
        ...
        let subscriber_with_wildcard_connect_bytes = [
            ...
            0x00, // Flags
            0x00, 0x00, // keep alive
            0x00, 0x02, 0x68, 0x65, // Client Identifier
        ];
        ...
        let publisher_connect_bytes = [
            ...
            0x00, // Flags
            0x00, 0x00, // keep alive
            0x00, 0x02, 0x68, 0x66, // Client Identifier
        ];
    ...
    //     let server = ServerTest::start("0.0.0.0:190".to_string());

    //     let mut stream_to_subscribe_with_wildcard =
    //         TcpStream::connect("0.0.0.0:190".to_string()).unwrap();
