mod tests {
    ...
    use server::{usermanager::{user_manager_types::ChannelUserManager, user_manager_action::UserManagerAction}, stream::stream_handler::{StreamType, StreamAction}, paquetes::disconnect::Disconnect};
    ...
    pub fn disconnect_succesfully() {
        ...
        Disconnect::disconnect_user("TestDisconnect".to_owned(), sender_user_manager, sender_stream);
