...
mod tests {
    ...
    fn create_complete_payload() {
        ...
        let remaining_bytes = [
            0x00, 0x02, 0x5C, 0x0B, 
            0x00, 0x06, 0x41, 0x4C, 0x54, 0x45, 0x47, 0x4F,  // ALTEGO will topic
            0x07, 0x00, 0x45, 0x47, 0x41, 0x53, 0x53, 0x45, 0x4D, // will message EGASSEM en hexa, al parsearlo queda como MESSAGE
            0x05, 0x00, 0x54, 0x4F, 0x50, 0x49, 0x43,
            0x00, 0x03, 0x41, 0x4C, 0x54,
        ];
        let connect_return_code = ConnectReturnCode::init();
        let (connect, _) =
            ConnectPayload::init(&connect_flags, &remaining_bytes, connect_return_code).unwrap();
